        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="exampleInputEmail1">SDK <input type="text" class="form-control inline-input" value="<?= $correta ?>" name="c"></label>
                    <input type="file" class="form-control" name="sdk_certo">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">SDK <input type="text" class="form-control inline-input" value="<?= $diferenciado ?>" name="d"></label>
        ...
        if ($compared) {
            ...
            <table class="table">
                ...
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">CONFIGURAÇÃO</th>
                    <th scope="col">VALOR CORRETO</th>
                    <th scope="col">VALOR DIFERENTE</th>
                </tr>
                </thead>
                <tbody>
                <?php
            ...
            <h2>Itens que estão no <span
                        class="badge badge-danger"><?= $diferenciado ?></span> e não no <span class="badge badge-success"><?= $correta ?></span>.
